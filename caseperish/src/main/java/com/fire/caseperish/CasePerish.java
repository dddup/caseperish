...
import com.fire.caseperish.compat.ActivityKillerV15_V20;
import com.fire.caseperish.compat.ActivityKillerV21_V23;
import com.fire.caseperish.compat.ActivityKillerV24_V25;
import com.fire.caseperish.compat.ActivityKillerV26;
import com.fire.caseperish.compat.ActivityKillerV28;
import com.fire.caseperish.compat.IActivityKiller;
...
public final class CasePerish {
    ...
    public static void install(Context ctx, ExceptionHandler exceptionHandler) {
        ...
        if (sExceptionHandler == null) {
            sExceptionHandler = new ExceptionHandler() {
                ...
                @Override
                protected void onBandageExceptionHappened(Thread t, Throwable throwable) {
    ...
    private static void notifyException(Throwable throwable) {
        ...
        if (isSafeMode()) {
            sExceptionHandler.bandageExceptionHappened(Looper.getMainLooper().getThread(), throwable);
        } else {
    ...
    private static void safeMode() {
        ...
        while (true) {
            try {
                ...
                isChoreographerException(e);
                if (sExceptionHandler != null) {
                    sExceptionHandler.bandageExceptionHappened(Looper.getMainLooper().getThread(), e);
                }
            }
        }
    }
